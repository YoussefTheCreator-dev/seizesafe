 ...
 *  Multi-Activity Logger for Seizure/Fall/FoG Detection
...
const char* WIFI_PASSWORD = "ysfthecreator@123";
...
void sendLine(const String& s) {
  ...
  // Always send via USB Serial (for serial_collector.py)
  Serial.println(s);
}
...
void setup() {
  ...
  u8g2.begin();
  showMessage("URIC", "Wearable", "Starting...");
  delay(1000);
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    showMessage("WiFi OK", ip.toString().c_str(), "Port:8888");
...
void loop() {
  ...
  if (!clientConnected) {
    ...
    if (newClient) {
      ...
      client.println("# URIC Wearable System Online");
      client.println("# Labels: 0=Stand 1=Walk 2=FastWalk 3=Sit 4=SitStand 5=Stairs 6=Fall 7=FoG 8=Seizure");
      beep(1000, 80); delay(60); beep(1000, 80);
      setLabelColor();
    }
  }
